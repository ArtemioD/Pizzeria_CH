...
function btn_contacto() {
    carusel(0);
    pizzas.html(contactoDePizzeria());
    pizzas.css("background", "none");
    //$("#contacto_de_pizzeria").css("background", "none");
    pizzas.css("height", "850px");
}

const contactoDePizzeria = () => `<article id="contacto_de_pizzeria">
